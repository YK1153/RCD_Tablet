...
namespace RcdOperationSystemConst
{
    public static class OperationConst
    {
        ...
        public static readonly int C_SYSTEM_MAX_TIMEOUT = 20000;

        // Hazard Timeout
        public static readonly int C_HAZARD_RUN_TIMEOUT = 10000;
        public static readonly int C_HAZARD_RESULT_TIMEOUT = 10000;
        ...
        // ↓ machii 20230511 ↓
        public static readonly string C_PROCTYPE_NORMAL = "00";
        public static readonly string C_PROCTYPE_RETRY = "01";
        // ↑ machii 20230511 ↑
    ...
    public class ConnectionConst
    {
        ...
        public static readonly string ManagementPC_IP = "127.0.0.1";
        public static readonly int ManagementPC_Port = 20000;
        ...
        public static readonly int AvpImageAnalysis_Port_Udp = 10010;
        ...
        public static readonly int ObjectDetect_Port_Snd = 30000;
        public static readonly int ObjectDetect_SndRate = 100;
        //public static readonly int ObjectDetect_Port_Rcv = 10011;
        public static readonly int ObjectDetect_Port_Rcv = 31000;
        ...
        // 操作端末
        public static readonly int Terminal_Srv_Port = 23000;
    }
