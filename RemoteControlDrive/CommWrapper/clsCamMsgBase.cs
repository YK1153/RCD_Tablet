...
{
    public abstract class CamMsgBase
    {
        /// <summary>
        /// 電文の連番
        /// </summary>
        ...
        {
            PropertyInfo[] props = typeof(CamMsgBase).GetProperties();
            PropertyInfo msgIdProp = typeof(CamMsgBase).GetProperty("MSGID");
    ...
    /// 車両側への送信電文用基底クラス
    /// </summary>
    public abstract class CamSndMsgBase : CamMsgBase, ISndMsgBase
    {
        // 送信メッセージID別シリアル採番リスト
        ...
        protected CamSndMsgBase(string msg_id)
        {
            MSGID = msg_id;
            lock (dictlock)
            {
    ...
    /// 車両側からの受信電文用基底クラス
    /// </summary>
    public abstract class CamRcvMsgBase : CamMsgBase
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        /// <param name="rcv_msg"></param>
        public CamRcvMsgBase(string rcv_msg)
        {
