...
{
    public abstract class CtrlManageMsgBase
    {
        /// <summary>
        /// 電文の連番
        /// </summary>
        ...
        {
            PropertyInfo[] props = typeof(CtrlManageMsgBase).GetProperties();
            PropertyInfo msgIdProp = typeof(CtrlManageMsgBase).GetProperty("MSGID");
    ...
    public abstract class CtrlManageSndMsgBase : CtrlManageMsgBase, ISndMsgBase
    {
        ...
        protected CtrlManageSndMsgBase(string msgId)
        {
            MSGID = msgId;
            lock (dictlock)
            {
    ...
    public abstract class CtrlManageRcvMsgBase : CtrlManageMsgBase
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        /// <param name="rcv_msg"></param>
        public CtrlManageRcvMsgBase(string rcv_msg)
        {
