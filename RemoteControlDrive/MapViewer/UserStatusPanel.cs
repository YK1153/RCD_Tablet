...
namespace MapViewer
{
    public partial class UserStatusPanel : UserControl
    {
        ...
        public const int C_PANEL_STATUS_WAIT_IDOL = 10;
        public const int C_PANEL_STATUS_WAIT_RUNNING = 11;
        public const int C_PANEL_STATUS_WAIT_READYBOOT = 12;
        public const int C_PANEL_STATUS_WAIT_STARTUP = 13;
        public const int C_PANEL_STATUS_WAIT_LEAVING = 14;
        public const int C_PANEL_STATUS_WAIT_ERROR = 15;
        ...
        public List<StatusDisplay> m_status = new List<StatusDisplay>()
        {
            ...
            new StatusDisplay(C_PANEL_STATUS_WAIT_IDOL,"次車両待ち",Color.Gray,Color.White),
            new StatusDisplay(C_PANEL_STATUS_WAIT_RUNNING,"処理中",Color.LawnGreen,Color.White),
            new StatusDisplay(C_PANEL_STATUS_WAIT_READYBOOT,"準備待ち",Color.Gold,Color.White),
            new StatusDisplay(C_PANEL_STATUS_WAIT_STARTUP,"起動待ち",Color.Gold,Color.White),
            new StatusDisplay(C_PANEL_STATUS_WAIT_LEAVING,"退出待ち",Color.Gold,Color.White),
            new StatusDisplay(C_PANEL_STATUS_WAIT_ERROR,"走行停止",Color.Red,Color.White),
        };
